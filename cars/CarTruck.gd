...
# mesh references
onready var right_wheel = $CarMesh/truck/tmpParent/truck/wheel_frontRight
onready var left_wheel = $CarMesh/truck/tmpParent/truck/wheel_frontLeft
onready var body_mesh = $CarMesh/truck/tmpParent/truck/body
onready var car_camera = $CarMesh/car_camera
onready var sphere_offset = -$Ball.translation


export (bool) var show_debug = false
export (Color,RGB) var car_color = Color(0,0,0)
...
func _physics_process(delta):
	if is_show:
		car_mesh.get_node("truck").rotate_y(1*delta)
		return
